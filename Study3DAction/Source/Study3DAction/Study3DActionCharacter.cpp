...
void AStudy3DActionCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AStudy3DActionCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AStudy3DActionCharacter::Move);
...
void AStudy3DActionCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AStudy3DActionCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
